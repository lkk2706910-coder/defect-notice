            ...
            <div class="card-body">
                ...
                <script>
                    ...
                    function getPivotMode() {
                        const r = document.querySelector('input.pivotmode:checked');
                    ...
                    function applyPivotModeVisibility() {
                        ...
                        document.querySelectorAll('[data-section="PIVOTPAT"]').forEach(el => {
                            el.style.display = (mode === 'GROUP') ? '' : 'none';
                        });
                        document.querySelectorAll('[data-section="PIVOTALL"]').forEach(el => {
                    ...
                    function applyPivotFabFilter() {
                        ...
                        document.querySelectorAll('table.pivotTable').forEach(tbl => {
                            // body cells
